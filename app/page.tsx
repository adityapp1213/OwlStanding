...
export default function Home() {
  ...
  return (
    <>
      <HeroHeader />
      <div className="relative min-h-screen bg-white px-3 py-6 md:px-12 md:py-12 pt-20 md:pt-24">
      <main className="relative z-10 mx-auto max-w-7xl">
        <div className="overflow-hidden rounded-2xl md:rounded-3xl border border-foreground/10 shadow-sm">
          <div className="relative bg-[linear-gradient(to_right,#e5e5e5_1px,transparent_1px),linear-gradient(to_bottom,#e5e5e5_1px,transparent_1px)] bg-[size:24px_24px] md:bg-[size:32px_32px] bg-white">
            ...
            {/*
              Color blobs — radial gradients that sit BEHIND the grid and content.
              Colors sampled from the team photo backgrounds:
                Anjali  → deep blue    #1a3fcc
                Aditya  → warm orange  #f5a343
                Brian   → muted yellow #e8c84a
                Darko   → teal/cyan    #38c4c4
              Each blob is a div with a radial-gradient, low opacity so the grid shows through.
            */}
            <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
              ...
              />
              {/* Grain overlay — tiled SVG noise, overlay blend so it textures not discolors */}
              <div
            ...
            <div className="relative z-20 flex flex-col items-center px-4 pt-8 pb-0 text-center md:px-10 md:pt-12">
              ...
              <p className="mt-3 md:mt-4 max-w-xl text-sm text-muted-foreground md:text-base px-2 md:px-0">
                ...
                Curabitur et ipsum eu purus molestie lobortis quis nec dolor.
              </p>
              ...
              >
                ...
                <div className="mt-3 flex flex-col sm:flex-row items-stretch gap-2 sm:gap-0 sm:overflow-hidden sm:rounded-full sm:border sm:border-foreground/85 sm:bg-foreground">
                  ...
                  <button
                    ...
                    className={`rounded-full sm:rounded-none sm:rounded-r-full bg-background px-6 py-3 h-auto text-[10px] md:text-[11px] font-semibold uppercase tracking-[0.18em] border border-foreground/85 sm:border-0 cursor-pointer transition-colors pointer-events-auto ${
                      email
