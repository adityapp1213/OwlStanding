...
const pricingData: PricingPlan[] = [
  {
    ...
    plan_name: "Starter",
    plan_descp: "Start your career journey with OwlStanding ",
    plan_price: 99,
    plan_feature: [
      "1 Live group class",
      "Career guidance from expert",
      "Live Q&A",
  ...
  },
  {
    ...
    plan_name: "Plus",
    plan_descp: "Get personal help from mentors.",
    plan_price: 249,
    plan_feature: [
      ...
      "Resume help",
      "LinkedIn help",
      "30-minute 1:1 call with mentor",
      "Interview preparation"
    ],
  },
  {
    plan_bg_color: "bg-pink-400/20",
    plan_name: "Pro",
    plan_descp: "Unlimited one-on-one mentorship.",
    plan_price: 499,
    plan_feature: [
      "Everything in Plus",
      "Unlimited mentor calls",
      "Resume reviews anytime",
      "Interview practice until you're ready",
      "Job & internship strategy",
